...
# If DATABASE_URL is set (Postgres / cloud), use it
# Else force SQLite into /tmp (Render writable path)
DATABASE_URL = os.getenv("DATABASE_URL")

if not DATABASE_URL:
    DB_PATH = "/tmp/civisense.db"
    DATABASE_URL = f"sqlite:///{DB_PATH}"

# SQLite needs this for FastAPI multithreading
